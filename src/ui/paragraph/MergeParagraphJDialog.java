...
public class MergeParagraphJDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			MergeParagraphJDialog dialog = new MergeParagraphJDialog();
	...
	public MergeParagraphJDialog() {
		...
		JLabel lblNewLabel = new JLabel("<html>请在左侧选取一个段，<br><br>被选取的段将合并到本段中来。</html>");
